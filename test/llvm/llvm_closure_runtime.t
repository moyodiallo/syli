Closure with multiple captured variables:
  ...
  public fn syliTest_multi.main(%__unit.0:i64) -> void:
    ...
    bb0:
      ...
      %Sy_oir_accum_fn_0:fn_ptr = addr_fn(__make_closure_accum.syliTest_multi.add.91_ret_i64)
      ...
      %Sy_cir_var_2:void = #call_direct syliTest_multi.syli_print_i64 (%Sy_cir_var_1:i64)
      return
  end
  ...
  private fn __make_closure_accum.syliTest_multi.add.91_ret_i64(%Sy_oir_x0:i64, %Sy_oir_x1:i64, %Sy_oir_clos:obj_ptr, %Sy_oir_dp_id:i64) -> i64:
    entry: bb0
  ...
  bb0:
    ...
    ; nop
    %Sy_oir_accum_fn_0 = bitcast ptr @__make_closure_accum.syliTest_multi.add.91_ret_i64 to ptr
  ...
  define i64 @__make_closure_accum.syliTest_multi.add.91_ret_i64(i64 %Sy_oir_x0, i64 %Sy_oir_x1, ptr addrspace(1) %Sy_oir_clos, i64 %Sy_oir_dp_id) gc "statepoint-example" {
  bb0:
