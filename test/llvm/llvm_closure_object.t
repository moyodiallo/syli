Closure with multipble chains of captured variables:
  ...
  bb0:
    ...
    ; nop
    call void @syli_rt_gc_cycle()
    %Sy_var1 = call ptr @syli_rt_ownership_alloc_object(i64 4251398048237748291, i32 1, i32 3)
    ; nop
    ...
    %Sy_release_tmp_1 = load ptr, ptr %Sy_tmp7
    ...
    %Sy_tmp8 = call ptr @syli_inlinable_ownership_untag(ptr %Sy_var1)
    %Sy_tmp9 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_tmp8, i32 0, i32 2, i32 1
    store ptr %Sy_tmp_1, ptr %Sy_tmp9
    %Sy_tmp10 = call ptr @syli_inlinable_ownership_untag(ptr %Sy_var1)
    %Sy_tmp11 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_tmp10, i32 0, i32 2, i32 2
    store i64 2, ptr %Sy_tmp11
    ; nop
    %Sy_tmp12 = call ptr @syli_inlinable_ownership_untag(ptr %Sy_var1)
    %Sy_tmp13 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_tmp12, i32 0, i32 2, i32 0
    %Sy_accum_ptr_2 = load ptr, ptr %Sy_tmp13
  ...
  define i64 @__make_closure_accum.syliTest_multi.add.40_ret_i64(i64 %Sy_x0, i64 %Sy_x1, ptr %Sy_clos, i64 %Sy_dp_id) {
  bb0:
  ...
  bb0:
    %Sy_tmp0 = call ptr @syli_inlinable_ownership_untag(ptr %Sy_clos)
    %Sy_tmp1 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_tmp0, i32 0, i32 2, i64 1
    %Sy_raw_tmp_2 = load ptr, ptr %Sy_tmp1
    %Sy_p_clos = call ptr @syli_rt_ownership_share(ptr %Sy_raw_tmp_2)
    ...
    %Sy_tmp4 = call ptr @syli_inlinable_ownership_untag(ptr %Sy_clos)
    %Sy_tmp5 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_tmp4, i32 0, i32 2, i64 2
...
Closure as an argument:
  ...
  bb0:
    call void @syli_rt_gc_cycle()
    %Sy_var0 = call ptr @syli_rt_ownership_alloc_object(i64 2377900603251621889, i32 1, i32 1)
    ; nop
  ...
  define i64 @__make_closure_accum.syliTest_multi.add.61_ret_i64(i64 %Sy_x0, i64 %Sy_x1, ptr %Sy_clos, i64 %Sy_dp_id) {
  bb0:
    call void @syli_inlinable_ownership_release(ptr %Sy_clos)
