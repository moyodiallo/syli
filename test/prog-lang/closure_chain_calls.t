  ...
  bb0:
    ...
    ; nop
    call void @syli_rt_gc_cycle()
    %Sy_var1 = call ptr @syli_rt_object_alloc(i64 4179340454199820355, i32 1, i32 3)
    ; nop
    ...
    %Sy_tmp_1 = call ptr @syli_ownership_own(ptr %Sy_var0)
    ...
    ; nop
    %Sy_tmp12 = call ptr @syli_ownership_untag(ptr %Sy_var1)
  ...
  bb0:
    ...
    %Sy_p_clos = call ptr @syli_rt_share(ptr %Sy_raw_tmp_2)
    ...
    %Sy_tmp4 = call ptr @syli_ownership_untag(ptr %Sy_clos)
