Complex test combining closures, dispatch, casts, partial application, and if-then-else:
  ...
  public fn syliComplex_dispatch.main() -> void:
    ...
    bb0:
      ...
      obj_set(%Sy_var1:obj_ptr, 1:i32, 5:i64):i64
      ...
      %Sy_var2:i64 = #call_direct syliComplex_dispatch.apply__fn_i64_i64_i64__i64__i64_ret_i64 (@transfer %Sy_var1:obj_ptr, 10:i64, 20:i64)
      %Sy_var3:void = #call_direct syliComplex_dispatch.syli_print_i64 (%Sy_var2:i64)
      gc_cycle
      %Sy_var4:obj{{card=3 [0:fn_ptr; 1:i64; 2:obj_ptr]} tag=0 unknow_cyclic} = object_create{size=3:i32}
      
      %Sy_accum_fn_2:fn_ptr = addr_fn(__partial_closure_accum.dispatch.clos0_arg2_ret_i64)
      obj_set(%Sy_var4:obj_ptr, 0:i32, %Sy_accum_fn_2:fn_ptr):fn_ptr
      obj_set(%Sy_var4:obj_ptr, 1:i32, 4:i64):i64
      %Sy_release_tmp_2:obj_ptr = @transfer obj_get(%Sy_var4:obj_ptr, 2:i32):obj_ptr
      release(%Sy_release_tmp_2:obj_ptr)
      obj_set(%Sy_var4:obj_ptr, 2:i32, @share %Sy_var0:obj_ptr):obj_ptr
      
      %Sy_var5:i64 = #call_direct syliComplex_dispatch.apply__fn_f64_f64_i64__f64__f64_ret_i64 (@transfer %Sy_var4:obj_ptr, 1.0f:f64, 2.0f:f64)
      %Sy_var6:void = #call_direct syliComplex_dispatch.syli_print_i64 (%Sy_var5:i64)
      gc_cycle
      %Sy_var7:obj{{card=4 [0:fn_ptr; 1:i64; 2:obj_ptr; 3:i64]} tag=0 unknow_cyclic} = object_create{size=4:i32}
      
      %Sy_accum_fn_3:fn_ptr = addr_fn(__partial_closure_accum.dispatch.clos1_arg1_ret_i64)
      obj_set(%Sy_var7:obj_ptr, 0:i32, %Sy_accum_fn_3:fn_ptr):fn_ptr
      obj_set(%Sy_var7:obj_ptr, 1:i32, 2:i64):i64
      %Sy_release_tmp_3:obj_ptr = @transfer obj_get(%Sy_var7:obj_ptr, 2:i32):obj_ptr
      release(%Sy_release_tmp_3:obj_ptr)
      obj_set(%Sy_var7:obj_ptr, 2:i32, @share %Sy_var0:obj_ptr):obj_ptr
      obj_set(%Sy_var7:obj_ptr, 3:i32, 2:i64):i64
      
      %Sy_accum_ptr_4:fn_ptr = obj_get(%Sy_var7:obj_ptr, 0:i32):fn_ptr
      %Sy_var8:i64 = #call_direct_fn_ptr(%Sy_accum_ptr_4:fn_ptr)  (30:i64, @borrow %Sy_var7:obj_ptr, 1:i64)
      
      %Sy_var9:void = #call_direct syliComplex_dispatch.syli_print_i64 (%Sy_var8:i64)
      %Sy_accum_ptr_5:fn_ptr = obj_get(%Sy_var7:obj_ptr, 0:i32):fn_ptr
      %Sy_apply_cast_6:i64 = cast(3.0f:f64 as i64)
      %Sy_var10:i64 = #call_direct_fn_ptr(%Sy_accum_ptr_5:fn_ptr)  (%Sy_apply_cast_6:i64, @transfer %Sy_var7:obj_ptr, 0:i64)
    ...
    bb2:
      gc_cycle
      %Sy_var16:obj{{card=3 [0:fn_ptr; 1:i64; 2:obj_ptr]} tag=0 unknow_cyclic} = object_create{size=3:i32}
      
      %Sy_accum_fn_7:fn_ptr = addr_fn(__partial_closure_accum.dispatch.clos0_arg2_ret_i64)
      obj_set(%Sy_var16:obj_ptr, 0:i32, %Sy_accum_fn_7:fn_ptr):fn_ptr
      obj_set(%Sy_var16:obj_ptr, 1:i32, 1:i64):i64
      %Sy_release_tmp_4:obj_ptr = @transfer obj_get(%Sy_var16:obj_ptr, 2:i32):obj_ptr
      release(%Sy_release_tmp_4:obj_ptr)
      obj_set(%Sy_var16:obj_ptr, 2:i32, @own %Sy_var0:obj_ptr):obj_ptr
      
      %Sy_var17:i64 = #call_direct syliComplex_dispatch.apply__fn_f64_f64_i64__f64__f64_ret_i64 (@transfer %Sy_var16:obj_ptr, 1.0f:f64, 2.0f:f64)
      %Sy_var13:i64 = move(%Sy_var17:i64)
      goto bb3
  
    bb1:
      gc_cycle
      %Sy_var14:obj{{card=2 [0:fn_ptr; 1:obj_ptr]} tag=0 unknow_cyclic} = object_create{size=2:i32}
      
      %Sy_accum_fn_8:fn_ptr = addr_fn(__partial_closure_accum.clos0_arg2_ret_i64)
      obj_set(%Sy_var14:obj_ptr, 0:i32, %Sy_accum_fn_8:fn_ptr):fn_ptr
      %Sy_release_tmp_5:obj_ptr = @transfer obj_get(%Sy_var14:obj_ptr, 1:i32):obj_ptr
      release(%Sy_release_tmp_5:obj_ptr)
      obj_set(%Sy_var14:obj_ptr, 1:i32, @own %Sy_var0:obj_ptr):obj_ptr
      
      %Sy_var15:i64 = #call_direct syliComplex_dispatch.apply__fn_i64_i64_i64__i64__i64_ret_i64 (@transfer %Sy_var14:obj_ptr, 100:i64, 200:i64)
      %Sy_var13:i64 = move(%Sy_var15:i64)
      goto bb3
  ...
  public fn syliComplex_dispatch.apply__fn_f64_f64_i64__f64__f64_ret_i64(%f:obj_ptr, %x:f64, %y:f64) -> i64:
    ...
    bb0:
      %Sy_accum_ptr_9:fn_ptr = obj_get(%f:obj_ptr, 0:i32):fn_ptr
      %Sy_apply_cast_10:i64 = cast(%x:f64 as i64)
      %Sy_apply_cast_11:i64 = cast(%y:f64 as i64)
      %Sy_var0:i64 = #call_direct_fn_ptr(%Sy_accum_ptr_9:fn_ptr)  (%Sy_apply_cast_10:i64, %Sy_apply_cast_11:i64, @transfer %f:obj_ptr, 0:i64)
  ...
  public fn syliComplex_dispatch.apply__fn_i64_i64_i64__i64__i64_ret_i64(%f:obj_ptr, %x:i64, %y:i64) -> i64:
    ...
    bb0:
      %Sy_accum_ptr_12:fn_ptr = obj_get(%f:obj_ptr, 0:i32):fn_ptr
      %Sy_var0:i64 = #call_direct_fn_ptr(%Sy_accum_ptr_12:fn_ptr)  (%x:i64, %y:i64, @transfer %f:obj_ptr, 0:i64)
