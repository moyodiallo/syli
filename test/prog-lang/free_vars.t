Closure with free variables:
  ...
  bb0:
    ...
    %Sy_tmp2 = call ptr @syli_inlinable_ownership_untag(ptr %syliTest_multi.apply__add)
    %Sy_tmp3 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_tmp2, i32 0, i32 2, i32 1
    store i64 1, ptr %Sy_tmp3
    ; nop
    %Sy_tmp4 = call ptr @syli_inlinable_ownership_untag(ptr %syliTest_multi.apply__add)
