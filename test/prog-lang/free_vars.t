Closure with free variables:
  ...
  bb0:
    ...
    %syliTest_multi.apply__add = call ptr @syli_rt_object_alloc(i64 2305843009213693954, i32 1, i32 2)
    ; nop
    %Sy_accum_fn_0 = bitcast ptr @__make_closure_accum.syliTest_multi.apply__add.27_ret_i64 to ptr
    %Sy_tmp0 = call ptr @syli_ownership_untag(ptr %syliTest_multi.apply__add)
    %Sy_tmp1 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_tmp0, i32 0, i32 2, i32 0
    store ptr %Sy_accum_fn_0, ptr %Sy_tmp1
    %Sy_tmp2 = call ptr @syli_ownership_untag(ptr %syliTest_multi.apply__add)
    %Sy_tmp3 = getelementptr { i64, i64, [0 x i64] }, ptr %Sy_tmp2, i32 0, i32 2, i32 1
    store i64 1, ptr %Sy_tmp3
    ; nop
    %Sy_tmp4 = call ptr @syli_ownership_untag(ptr %syliTest_multi.apply__add)
