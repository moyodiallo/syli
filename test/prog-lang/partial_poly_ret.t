  ...
  public fn syliTest_multi.main(%__unit.0:i64) -> i64:
    ...
    bb0:
      %Sy_var0:(?60, ?61 -> ?61) = #make_closure {syliTest_multi.add} () ( captured_args=[1:i64])
      %Sy_var1:i64 = #call_apply {%Sy_var0:(?60, ?61 -> ?61) as (f64, i64 -> i64)}  (1.0f:f64, 2:i64)
      %Sy_var2:i64 = #call_apply {%Sy_var0:(?60, ?61 -> ?61) as (i64, i64 -> i64)}  (1:i64, 2:i64)
      return %Sy_var2:i64
  end
...
%Sy_case_result0:i64 = #call_direct __wrapper.syliTest_multi.add.i64_i64_i64_ret_i64 (%Sy_val0:i64, %Sy_x0:i64)
  ...
  public fn syliTest_multi.main(%__unit.0:i64) -> i64:
    ...
    bb0:
      ...
      %Sy_accum_fn_0:fn_ptr = addr_fn(__make_closure_accum.dispatch.31_ret_i64)
  ...
  private fn __make_closure_accum.dispatch.31_ret_i64(%Sy_x0:i64, %Sy_x1:i64, %Sy_clos:obj_ptr, %Sy_dp_id:i64) -> i64:
    entry: bb-1
