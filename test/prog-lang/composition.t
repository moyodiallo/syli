  ...
  public fn syliTest_file.main() -> void:
    ...
    bb0:
      ...
      %Sy_accum_fn_0:fn_ptr = addr_fn(__make_closure_accum.syliTest_file.id.54_ret_i64)
      obj_set(%Sy_var0:*void, 0:i32, %Sy_accum_fn_0:fn_ptr):fn_ptr
      
      %Sy_var1:i64 = #call_direct syliTest_file.apply_twice__fn_i64_i64__i64_ret_i64 (@transfer %Sy_var0:*void, 10:i64)
      %Sy_var2:void = #call_direct syliTest_file.syli_print_i64 (%Sy_var1:i64)
      return
  end
  
  public fn syliTest_file.apply_twice__fn_i64_i64__i64_ret_i64(%f:*void, %x:i64) -> i64:
    entry: bb0
  ...
  private fn __make_closure_accum.syliTest_file.id.54_ret_i64(%Sy_x0:i64, %Sy_clos:*void, %Sy_dp_id:i64) -> i64:
    entry: bb0
  ...
  bb0:
    ...
    %Sy_tmp_1 = call ptr @syli_inlinable_ownership_borrow(ptr %f)
    %Sy_var0 = call i64 %Sy_accum_ptr_1(i64 %x, ptr %Sy_tmp_1, i64 0)
    ; nop
    %Sy_tmp2 = call ptr @syli_inlinable_ownership_untag(ptr %f)
