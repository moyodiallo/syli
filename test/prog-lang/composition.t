  ...
  define i64 @syliTest_file.apply_twice__fn_i64_i64__i64_ret_i64(ptr addrspace(1) %f, i64 %x) {
  bb0:
  ...
  define i64 @__make_closure_accum.syliTest_file.id.53_ret_i64(i64 %Sy_x0, ptr addrspace(1) %Sy_clos, i64 %Sy_dp_id) {
  bb0:
