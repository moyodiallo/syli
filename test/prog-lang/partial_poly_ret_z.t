  ...
  public fn syliTest_multi.main(%__unit.0:i64) -> i64:
    ...
    bb0:
      ...
      %Sy_accum_fn_0:fn_ptr = addr_fn(__make_closure_accum.dispatch.39_ret_i64)
      ...
      %Sy_apply_tmp_3:i64 = #call_direct_fn_ptr(%Sy_accum_ptr_1:fn_ptr)  (%Sy_apply_cast_2:i64, @borrow %Sy_var0:obj_ptr, 1:i64)
      %Sy_var1:f64 = cast(%Sy_apply_tmp_3:i64 as f64)
      
      %Sy_accum_ptr_4:fn_ptr = obj_get(%Sy_var0:obj_ptr, 0:i32):fn_ptr
      %Sy_var2:i64 = #call_direct_fn_ptr(%Sy_accum_ptr_4:fn_ptr)  (1:i64, @transfer %Sy_var0:obj_ptr, 0:i64)
  ...
  private fn __make_closure_accum.dispatch.39_ret_i64(%Sy_x0:i64, %Sy_clos:obj_ptr, %Sy_dp_id:i64) -> i64:
    entry: bb-1
